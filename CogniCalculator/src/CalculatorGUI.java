...
public class CalculatorGUI extends javax.swing.JFrame {
    ...
    public void operacjeMatematyczne(){
            ...
            switch(operacja)
            {
                ...
                case 5://potęgowanie              
                 wynik = Math.pow(aktualnaLiczba, Double.parseDouble(jTextField1.getText()));
                 wyswietlaczTemp = (Double.parseDouble(jTextField1.getText()));
                 jTextField1.setText(aktualnaLiczba + "^" + wyswietlaczTemp + "=" + wynik); 
                 break;
                 
                 case 6://pierwiastkowanie             
                 wynik = Math.sqrt(aktualnaLiczba);
    ...
    jLabel1.setText("Uzyj przycisku C, aby wyczyścić ekran");
    ...
    //pierwiastkowanie
    aktualnaLiczba = Integer.parseInt(jTextField1.getText()); 
       operacja = 6;
       jTextField1.setText(" "); 
       jLabel1.setText("√" + aktualnaLiczba);
